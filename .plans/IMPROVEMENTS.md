...
**Status**: All 7 items below implemented (2026-02; PR #3 + follow-ups). Scope in game titles; Hangman shows verse with blank from start, peek keeps word hidden; Memory pairs prompt 2–4; case-insensitive search; quit confirmation; search "(Enter to cancel)".
...
4. **Reference parsing: abbreviations**
...
5. **Error messages: Finnish vs English**
